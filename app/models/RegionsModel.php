<?php 
    ...
    class RegionsModel{
        ...
        static public function getData($table){
            ...
            $sql ="SELECT regions.id, regions.name_region, countries.name_country FROM $table INNER JOIN countries on regions.id_country = countries.id";
            $connection=new Connection();
            $conexion = $connection->connect();
            if($conexion){
                $stmt = $conexion->prepare($sql);
        ...
        static public function getDataId($table, $id){
            ...
            $sql ="SELECT regions.id, regions.name_region, countries.name_country FROM $table INNER JOIN countries on regions.id_country = countries.id WHERE regions.id=".$id;
