<?php 
    ...
    class CitiesModel{
        ...
        static public function getData($table){
            ...
            $sql ="SELECT cities.id, cities.name_city, regions.name_region FROM $table INNER JOIN regions on cities.id_region = regions.id";
            $connection=new Connection();
            $conexion = $connection->connect();
            if($conexion){
                $stmt = $conexion->prepare($sql);
        ...
        static public function getDataId($table, $id){
            ...
            $sql ="SELECT cities.id, cities.name_city, regions.name_region FROM $table INNER JOIN regions on cities.id_region = regions.id WHERE cities.id=".$id;
